 ...
 */
public class ArrayBlockingQueueRyan<E> extends AbstractQueue<E>
     ...
     */
    public ArrayBlockingQueueRyan(int capacity) {
        this(capacity, false);
    }
     ...
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public ArrayBlockingQueueRyan(int capacity, boolean fair) {
        if (capacity <= 0)
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            lastRet = NONE;
            final ReentrantLock lock = ArrayBlockingQueueRyan.this.lock;
            lock.lock();
            try {
                if (count == 0) {
                    // assert itrs == null;
                    ...
                    final int takeIndex = ArrayBlockingQueueRyan.this.takeIndex;
        ...
        public void forEachRemaining(Consumer<? super E> action) {
            ...
            try {
                ...
                final Object[] items = ArrayBlockingQueueRyan.this.items;
